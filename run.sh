...
# ./test.ex -k 0.5 -td 0.1 -mf 1 -f ./data/Noh/32x32/Compute_Model_For_TriAngels.txt

# with heat flux and without matter-flow
# ./test.ex -k 0.5 -td 0.1 -mf 0 -f ./data/Noh/32x32/Compute_Model_For_TriAngels.txt

# without heat flux and without matter-flow
# ./test.ex -k 0.5 -td 0.0 -mf 0 -f ./data/Noh/32x32/Compute_Model_For_TriAngels.txt


### Sedvo
# ./test.ex -k 0.5 -td 0.05 -mf 1 -f ./data/Sedvo/32x32/Compute_Model_For_TriAngels.txt
